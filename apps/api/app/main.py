...
def create_app(
    ...
    app.state.llm_client = llm_client or OpenAIChatClient.from_settings(settings)
    app.state.embeddings_client = embeddings_client or OpenAIEmbeddingsClient.from_settings(settings)
